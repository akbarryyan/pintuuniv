    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="text-center">
          <Link
            href="/register"
            className="bg-emerald-500 text-white px-6 py-3 font-black text-lg uppercase border-4 border-slate-800 transform hover:-rotate-1 hover:-translate-y-2 transition-all duration-200 shadow-brutal inline-block"
          >
            🚀 LANJUT DAFTAR
          </Link>
        </div>
