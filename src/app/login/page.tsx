...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-blue-50 to-emerald-100 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-16 h-16 bg-orange-400 rotate-12 border-4 border-slate-800 opacity-30 animate-bounce"></div>
      <div className="absolute top-40 right-20 w-12 h-12 bg-blue-400 rounded-full border-4 border-slate-800 opacity-40 animate-pulse"></div>
      <div className="absolute bottom-32 left-20 w-20 h-20 bg-emerald-400 rotate-45 border-4 border-slate-800 opacity-25 animate-spin"></div>
      <div className="absolute bottom-20 right-10 w-14 h-14 bg-violet-400 border-4 border-slate-800 opacity-35 animate-ping"></div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-block mb-6">
              <div className="bg-orange-500 text-white px-6 py-3 border-4 border-slate-800 shadow-brutal transform rotate-2 hover:rotate-3 transition-transform">
            ...
            <div className="bg-blue-400 text-slate-900 px-4 py-2 border-3 border-slate-800 inline-block shadow-brutal transform -rotate-1">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 pr-12 border-3 border-slate-800 bg-blue-50 text-slate-900 font-bold placeholder-slate-500 focus:outline-none focus:bg-blue-100 focus:border-blue-500 transition-colors"
