  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.error || 'Gagal memperbarui diskusi');
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-black text-slate-900 mb-4">Diskusi Tidak Ditemukan</h1>
          <button
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 pb-24 sm:pb-8">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-4 sm:p-6 border-3 border-slate-800 shadow-brutal mb-6">
          <h1 className="text-2xl sm:text-3xl font-black mb-2 uppercase">
            ✏️ Edit Diskusi
          </h1>
          <p className="text-sm sm:text-base font-bold opacity-90">
            Perbarui judul, konten, dan tag diskusi Anda
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="px-6 py-3 font-black text-sm border-3 border-slate-800 bg-orange-500 text-white hover:bg-orange-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors shadow-brutal flex items-center gap-2"
            >
              {saving ? (
                <>
